...
/// Holds a palette of colors used for final theming.
class AppPalette {
  /// Background.
  ...
  static const Color textGreen = Color(0xFF39937E);
  static const Color textRed = Color(0xFFDF441E);

  /// Button.
  static const Color buttonDefault = Color(0xFF47B89E);
  static const Color buttonDisabled = Color(0xFFBCC8CC);

  /// Border
  static const Color borderWhite = Color(0xFFE4EAEB);
  static const Color borderGreen = Color(0xFF47B89E);
